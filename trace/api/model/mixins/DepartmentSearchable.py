...
class DepartmentSearchable(object):
    @classmethod
    ...
    def search(cls, expr, page, per_page):
        ...
        ids = [x['department_id'] for x in search_result]
        return cls.map_all_departments(ids) if ids else []

    @classmethod
    def map_all_departments(cls, ids):
    ...
    @classmethod
    def elastic_search(cls, query, fields_list, page, per_page, id_field_name='department_id', highlights=False,
                       index='department'):
